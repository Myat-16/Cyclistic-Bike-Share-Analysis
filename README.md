...
3. Member and casual ride counts were nearly equal in June
4. Weekends saw the highest activity, mainly from casual users
5. Members rode more during weekdays 

### Insights for July to Sep
1. Total rides decreased by roughly 10% from July to September, showing a steady month-to-month decline.
2. Both member and casual rides trended downward, with casual riders showing the sharpest drop.
3. Average ride duration fell each month for both groups, though casual riders consistently rode longer than members.
4. Classic bikes drove most of the overall decline in ridership.
...
3. Focused on patterns in user types, ride types, and timing

#### Tools that I used:
1.  Python (for data cleaning and transformation)
2. Excel (for dashboard creation and visualization)
